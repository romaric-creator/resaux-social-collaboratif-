            ...
            try {
                ...
                $csrf_token = $_POST['csrf_token'] ?? null;
                  if (!validateCSRFToken($csrf_token)) {
                    $error_message = 'CSRF token invalide.';
                     break;
                 }
        ...
        <form action="settings.php" method="POST" enctype="multipart/form-data" class="modern-form">
            <fieldset style="margin-bottom:2em;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="localisation" name="localisation" value="<?php echo htmlspecialchars($user_data['localisation'] ?? ''); ?>" required>
                </div>
                <div class="form-group file-upload-group" style="display:flex;align-items:center;gap:1em;">
                    ...
                    <?php if ($user_data['photo_profil']): ?>
                        <div class="current-photo-preview">
                            <img src="<?php echo getUserProfilePhoto($user_data['photo_profil']); ?>" alt="Photo de profil actuelle">
            ...
            <?php if ($user_data['type_user'] === 'entreprise'): ?>
                <fieldset style="margin-bottom:2em;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description"><?php echo htmlspecialchars($user_data['description'] ?? ''); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="secteur">Secteur d'activité :</label>
                        <input type="text" id="secteur" name="secteur" value="<?php echo htmlspecialchars($user_data['secteur'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="horaires_ouverture">Horaires d'ouverture :</label>
                        <input type="text" id="horaires_ouverture" name="horaires_ouverture" placeholder="Ex: Lun-Ven: 9h-18h" value="<?php echo htmlspecialchars($user_data['horaires_ouverture'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="site_web" name="site_web" placeholder="https://votresite.com" value="<?php echo htmlspecialchars($user_data['site_web'] ?? ''); ?>">
                    </div>
                    <div class="form-group file-upload-group" style="display:flex;align-items:center;gap:1em;">
                        <div>
                            <label for="cover_photo">Photo de couverture :</label>
                            <input type="file" id="cover_photo" name="cover_photo" accept="image/*">
                            <p class="help-text">Taille max : 10MB. Formats : JPG, PNG, GIF. Idéale pour la bannière de profil.</p>
                        </div>
                        <?php if ($user_data['photo_couverture']): ?>
                            <div class="current-photo-preview">
                                <img src="<?php echo getCompanyCoverPhoto($user_data['photo_couverture']); ?>" alt="Photo de couverture actuelle">
                ...
                <fieldset style="margin-bottom:2em;">
                    ...
                    <p class="help-text">Entrez les coordonnées latitude et longitude pour afficher votre entreprise sur une carte.</p>
                    <div class="form-group">
                        <label for="latitude">Latitude :</label>
                        <input type="text" id="latitude" name="latitude" value="<?php echo htmlspecialchars($user_data['latitude'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="longitude">Longitude :</label>
                        <input type="text" id="longitude" name="longitude" value="<?php echo htmlspecialchars($user_data['longitude'] ?? ''); ?>">
                    </div>
                </fieldset>
            <?php endif; ?>
