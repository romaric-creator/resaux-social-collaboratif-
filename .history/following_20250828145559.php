                        ...
                        <div class="followers-list-card">
                            ...
                            <div class="followers-info">
                                ...
                                <?php if ($f['localisation']): ?>
                                    <span class="followers-location"> 
                                        <i class="fas fa-map-marker-alt"></i>
                                        <?php echo htmlspecialchars($f['localisation']); ?>
                                        <button class="save-location-btn" data-user-id="<?php echo $f['id']; ?>" data-location="<?php echo htmlspecialchars($f['localisation'], ENT_QUOTES); ?>">
                                            <i class="fas fa-bookmark"></i> Sauvegarder la position
                                        </button>
                                    </span>
                                <?php endif; ?>
                            </div>
