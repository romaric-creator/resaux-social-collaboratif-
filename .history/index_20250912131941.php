            ...
            <?php if (!empty($suggested_users)): ?>
                <?php foreach ($suggested_users as $s_user): ?>
                    <div class="suggestion-item">
                        ...
                        <button class="button <?php isFollow($conn,$_SESSION['user_id'],$s_user['id']) != 1 ? "button-small" : "button-secondary" ?> follow-btn"
                            data-user-id="<?php echo $s_user['id']; ?>">
                            suivre
                            <?php isFollow($conn,$_SESSION['user_id'],$s_user['id']) != 1 ? "button-small" : "button-secondary"  ?>
                        </button>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
