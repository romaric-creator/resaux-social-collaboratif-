...
<div class="main-content profile-page"
    ...
    <div class="profile-info-area" style="margin-top: 60px;">
            ...
            <div style="display:flex; gap:2em; justify-content:center; margin:1em 0 0.5em 0;">
                <a href="followers.php?id=<?php echo $profile_id; ?>" style="text-decoration:none; color:#222; font-weight:600;">
                    <span style="font-size:1.2em;"><?php echo $followers_count; ?></span><br><span style="font-size:0.95em; color:#3b82f6;">Abonnés</span>
                </a>
                <a href="following.php?id=<?php echo $profile_id; ?>" style="text-decoration:none; color:#222; font-weight:600;">
                    <span style="font-size:1.2em;"><?php echo $following_count; ?></span><br><span style="font-size:0.95em; color:#3b82f6;">Abonnements</span>
                </a>
            </div>
    ...
    <div class="profile-left-sidebar" style="box-shadow: 0 4px 24px rgba(0,0,0,0.07); word-break: break-word; overflow-wrap: anywhere;">
            ...
            <?php if ($profile_user['type_user'] === 'entreprise'): ?>
                ...
                <p style="white-space: pre-line; word-break: break-word; overflow-wrap: anywhere;"><i class="fas fa-align-left"></i> <strong>Description:</strong>
                ...
                <?php if (!empty($profile_user['localisation'])): ?>
                    <p><i class="fas fa-map-marker-alt"></i> <strong>Adresse:</strong>
                        <?php echo htmlspecialchars($profile_user['localisation']); ?></p>
                <?php endif; ?>
                <!-- Bouton de géolocalisation pour l'entreprise connectée -->
                <?php if ($is_current_user_profile): ?>
                    <button id="save-location-btn" class="button" style="margin-bottom:10px;">
                        <i class="fas fa-map-pin"></i> Sauvegarder ma position
                    </button>
                    <div id="save-location-msg" style="margin-bottom:10px;color:var(--primary-color);"></div>
                <?php endif; ?>
                            ...
                            <div class="post-card" data-post-id="<?php echo $pub['id']; ?>">
                                ...
                                <div class="post-actions">
                                    ...
                                    <button class="action-btn share-btn" data-post-id="<?php echo $pub['id']; ?>"
                                        onclick="navigator.clipboard.writeText('<?php echo BASE_URL; ?>publication.php?id=<?php echo $pub['id']; ?>'); alert('Lien de la publication copié !'); return false;">
...
<script>
// Correction : injection de la variable base_url pour le JS AJAX (like/comment/share)
