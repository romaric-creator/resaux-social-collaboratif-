...
<div class="main-content" style="width:90%;margin:2em auto;">
    <div class="followers-header">
        <h2 style="color:#3b82f6;"><i class="fas fa-users"></i> Abonnés de
                ...
                <div class="followers-list-card">
                    ...
                    <div style="flex:1;min-width:0;">
                        <a href="profile.php?id=<?php echo $f['id']; ?>"
                            style="font-weight:600;font-size:1.13em;color:#222;text-decoration:none;word-break:break-word;"><?php echo htmlspecialchars($f['nom']); ?></a><br>
    ...
    <?php endif; ?>
    <div style="text-align:center;width: 300px;margin-top:2em;">
