...
<head>
    ...
    <title>
        <?php echo isset($page_title) ? htmlspecialchars($page_title) . ' - Plateforme Tourisme' : 'Plateforme Tourisme et Loisirs'; ?>
    </title>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" integrity="sha512-papm6QpQwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Qv6QwQK1Q==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body>
    <header class="header">
        ...
        <nav class="header-center nav-links">
            <a href="<?php echo BASE_URL; ?>index.php" title="Accueil"><i
                    class="fas fa-home"></i><span>Accueil</span></a>
            <a href="<?php echo BASE_URL; ?>entreprise/explore.php" title="Explorer les entreprises"><i
                    class="fas fa-building"></i><span>Entreprises</span></a>
            <a href="<?php echo BASE_URL; ?>profile.php?id=<?php echo $current_user_id; ?>" title="Mon profil"><i
                    class="fas fa-user-circle"></i><span>Profil</span></a>
            <a href="<?php echo BASE_URL; ?>chat/" title="Messagerie"><i
                    class="fas fa-comment-dots"></i><span>Chat</span></a>
            <a href="<?php echo BASE_URL ?>notifications.php" title="Notifications"><i class="fas fa-bell"></i><span>Notifications</span></a>
        </nav>
        <div class="header-right">
            <?php if ($current_user_id): ?>
                <div class="profile-menu">
                    <img src="<?php echo $current_user_photo; ?>" alt="Photo de profil"
                        title="<?php echo htmlspecialchars($current_user_name); ?>">
                    <div class="dropdown-menu">
                        <a href="<?php echo BASE_URL; ?>profile.php?id=<?php echo $current_user_id; ?>"><i
                                class="fas fa-user"></i> Mon Profil</a>
                        <?php if ($current_user_type === 'entreprise'): ?>
                            <a href="<?php echo BASE_URL; ?>entreprise/dashboard.php"><i class="fas fa-briefcase"></i> Espace
                                Entreprise</a>
                        <?php endif; ?>
                        <?php if ($current_user_type === 'admin'): ?>
                            <a href="<?php echo BASE_URL; ?>admin/dashboard.php"><i class="fas fa-user-shield"></i>
                                Administration</a>
                        <?php endif; ?>
