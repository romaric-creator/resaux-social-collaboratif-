    ...
    <div class="main-content">
        <div class="left-sidebar">
            ...
            <a href="<?php echo BASE_URL; ?>profile.php?id=<?php echo $_SESSION['user_id']; ?>" class="menu-item profile-link-sidebar">
                <img src="<?php echo getUserProfilePhoto($_SESSION['user_photo_profil'] ?? null); ?>" alt="Profil" class="profile-pic-small">
                <span><?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
            </a>
            <div class="sidebar-section">
                <a href="<?php echo BASE_URL; ?>index.php" class="menu-item"><i class="fas fa-newspaper"></i> Fil d'actualité</a>
                <a href="<?php echo BASE_URL; ?>chat/" class="menu-item"><i class="fas fa-comments"></i> Messagerie</a>
                <a href="<?php echo BASE_URL; ?>entreprise/explore.php" class="menu-item"><i class="fas fa-building"></i> Explorer entreprises</a>
                <a href="#" class="menu-item"><i class="fas fa-bookmark"></i> Vos Favoris</a>
                <a href="#" class="menu-item"><i class="fas fa-calendar-alt"></i> Événements</a>
                <?php if (isEntreprise()): ?>
                    <a href="<?php echo BASE_URL; ?>entreprise/dashboard.php" class="menu-item"><i class="fas fa-briefcase"></i> Espace Entreprise</a>
                <?php endif; ?>
                <?php if (isAdmin()): ?>
                    <a href="<?php echo BASE_URL; ?>admin/dashboard.php" class="menu-item"><i class="fas fa-user-shield"></i> Panneau Admin</a>
                <?php endif; ?>
            </div>
                ...
                <form action="index.php" method="GET" class="filter-form">
                    <div class="form-group">
                        ...
                        <select name="location" id="location-filter" class="form-control">
                            <option value="Toutes" <?php echo ($filter_location == 'Toutes') ? 'selected' : ''; ?>>Toutes</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="sort" id="sort-by" class="form-control">
                            <option value="date" <?php echo ($sort_by == 'date') ? 'selected' : ''; ?>>Date (le plus récent)</option>
                            <option value="popularite" <?php echo ($sort_by == 'popularite') ? 'selected' : ''; ?>>Popularité</option>
                        </select>
                    </div>
...
<?php endif; ?>
        ...
        <div class="right-sidebar">
                ...
                <?php if (!empty($suggested_users)): ?>
                    <?php foreach ($suggested_users as $s_user): ?>
                        <div class="suggestion-item">
                            <img src="<?php echo getUserProfilePhoto($s_user['photo_profil']); ?>" alt="Profil" class="profile-pic-small">
                            <div class="suggestion-info">
                                <a href="<?php echo BASE_URL; ?>profile.php?id=<?php echo $s_user['id']; ?>" class="suggestion-name"><?php echo htmlspecialchars($s_user['nom']); ?></a>
                            ...
                            <button class="button button-small follow-btn" data-user-id="<?php echo $s_user['id']; ?>">Suivre</button>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            <div class="sidebar-section">
                ...
                <img src="<?php echo BASE_URL; ?>assets/images/ad_placeholder.png" alt="Publicité" style="max-width: 100%; border-radius: 8px;">
            </div>
        </div>
...
$(document).on('click', '.like-btn', function(e) {
    ...
    $.post('ajax_handler.php', { action: 'toggle_like', post_id: postId }, function(response) {
        if (response.success) {
            ...
            $btn.closest('.post-card').find('.likes-count').text((response.data && typeof response.data.likes_count !== 'undefined' ? response.data.likes_count : 0) + ' Likes');
        }
    }, 'json');
});
