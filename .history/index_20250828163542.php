...
<div class="main-content">
    <div class="left-sidebar">
        ...
        <div class="sidebar-section">
            ...
            <a href="<?php echo BASE_URL; ?>favoris.php" class="menu-item"><i class="fas fa-heart"></i> Vos Favoris</a>
            <a href="<?php echo BASE_URL; ?>evenement.php" class="menu-item"><i class="fas fa-calendar-alt"></i> Événements</a>
            <?php if (isEntreprise()): ?>
        ...
        <div class="sidebar-section filter-sort-section">
            <h3><i class="fas fa-filter"></i> Options de tri</h3>
            <form action="index.php" method="GET" class="filter-form">
                ...
                <div class="form-group">
                    <label for="sort-by">Trier les publications par :</label>
        ...
        <?php if (isEntreprise()): ?>
            <div class="create-post-card">
                ...
                <form action="<?php echo BASE_URL; ?>entreprise/add_publication.php" method="GET">
                    <textarea class="post-input" placeholder="Partagez votre actualité, vos nouveautés, etc. (Cliquez ici pour ajouter une annonce complète)" disabled></textarea>                    <div class="post-actions-create">
    ...
    <div class="right-sidebar">
            ...
            <?php if (!empty($suggested_users)): ?>
                <?php foreach ($suggested_users as $s_user): ?>
                    <div class="suggestion-item">
                        ...
                        <button class="button button-small follow-btn"
                            data-user-id="<?php echo $s_user['id']; ?>">Suivre</button>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
        ...
        <div class="sidebar-section">
           ...
           <a href="#" class="button button-small secondary">Créer un événement</a>
        </div>
        <div class="sidebar-section">
