...
<div class="main-content profile-page" style="background: linear-gradient(135deg, #f8fafc 0%, #e9f0fb 100%); min-height: 100vh; padding-bottom: 40px;">
    <div class="profile-header-section">
        <div class="cover-photo">
            ...
            <?php endif; ?>
            <div style="position: absolute; left: 50%; bottom: -80px; transform: translateX(-50%); z-index: 11;">
                <img src="<?php echo getUserProfilePhoto($profile_user['photo_profil']); ?>" alt="Photo de profil" class="profile-pic-large" style="box-shadow: 0 4px 16px rgba(0,0,0,0.12);">
                <?php if ($is_current_user_profile): ?>
                    <button class="edit-profile-pic-btn button button-small" style="top: 120px; left: 50%; transform: translateX(-50%); position: absolute;"><i class="fas fa-camera"></i> Modifier le profil</button>
                <?php endif; ?>
            </div>
        </div>
